...
.curso-main-container.pb-3
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.mb-5
      p(data-aos="fade-right") La siguiente imagen es un ejemplo de la información que se encuentra en la farmacopea y su utilidad para la fabricación de los productos farmacéuticos.
    .bg5.mb-5
